...
export default function HelpPanel() {
    ...
    const symbols = [
        ...
        { key: 'V', name: '谓语 (Verb)', desc: '动作或状态。', example: 'The fox jumps.', target: 'jumps', color: '#991b1b' },
        { key: 'O', name: '宾语 (Object)', desc: '动作的承受者。', example: 'He eats an apple.', target: 'an apple', color: '#065f46' },
        ...
        { key: 'PAS', name: '被动语态 (Passive Voice)', desc: '当主语是动作的承受者时使用。', example: 'The cake was eaten.', target: 'was eaten', color: '#c2410c' },
